...
<div class="body_plugin">
	<div class="content_plugin">
		...
		<form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>" name="ietk_form_upload_csv" id="ietk_form_upload_csv" class="formulario" enctype="multipart/form-data"> 
			<div>
				<label for="">archivo csv:</label> 
				<input class="fileUpload_avatar" type="file"  name="archivo_csv" /> 
			</div>
			<div>
				<input type="submit" name="enviar" id="enviar" />
			</div> 
			<input type="hidden" name="action" value="ietk_form_upload_csv">
			<?php wp_nonce_field( 'ietk_form_upload_csv_nonce', 'name_of_nonce_field' ); ?>
        ...
        <div class="cols">
			<form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>" name="ietk_after_form_upload_csv" id="ietk_after_form_upload_csv" class="formulario"> 
               <input type="hidden" name="action" value="ietk_after_form_upload_csv">
                <?php wp_nonce_field( 'ietk_after_form_upload_csv_nonce', 'name_of_nonce_field' ); ?>
            </form> 
			<form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>" name="ietk_delete_files" id="ietk_delete_files" class="formulario"> 
				<div id="ajax_results_listado" class="">
					<?php ietk_listarArchivos("../_tk_csv/"); ?>
				</div> 
               <input type="hidden" name="action" value="ietk_delete_files">
				...
				<input type="hidden" name="carpeta" value="/_tk_csv/" />
